...
// Définis les props du bouton, y compris ref
type ButtonProps = {
  children: React.ReactNode;
  variant?: "default" | "outlined" | "gradient" | "link" | "sidebar" | "error" | "warning" | "success" | "select";
  size?: "sm" | "md" | "lg";
  rounded?: boolean;
  loading?: boolean;
...
// Utilise forwardRef pour transmettre la ref
  ...
  (
    ...
    if (href) {
      return (
        <Link
          ...
          ref={ref as React.RefObject<HTMLAnchorElement>} // Forward la ref au Link
        >
          {content}
        </Link>
      );
    ...
    return (
      <button
        ...
        disabled={isDisabled}
        title={title}
        ref={ref as React.RefObject<HTMLButtonElement>} // Forward la ref au button
      >
        {content}
      </button>
    );
...
Button.displayName = "Button"; // Optionnel, pour débogage
