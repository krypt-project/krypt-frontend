...
export const ChatBotInterface = forwardRef<HTMLDivElement, Props>(
  ({ isOpen, onClose }, ref) => {
        ...
        >
          ...
          <div className="flex items-start gap-3">
            <p className="flex-wrap px-3 py-2 max-w-[90%] rounded-2xl w-auto text-[var(--text-dark)]">
              ...
              You are in the <b>Global</b> chatbot, you can ask me to explain
              you something or accomplishe a task for you
            </p>
          </div>
          <div className="flex items-start gap-3 justify-end">
              ...
              <Input
                ...
                onInput={(e) => {
                  ...
                  if (chatZoneRef.current) {
                    chatZoneRef.current.style.paddingBottom = `${
                      clamped + 16
                    }px`;
                  }
                }}
